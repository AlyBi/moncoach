...
const Navbar: React.FC = () => {
    ...
    return (
        <header id="header" className="header d-flex align-items-center sticky-top">
            <div className="container position-relative d-flex align-items-center">
                <Link to="/" className="logo d-flex align-items-center me-auto" onClick={closeMenu}>
                    <img src={logo} alt="Logo" className="logo-img" />
                    <h1 className="sitename">life design coaching</h1>
                </Link>
                <nav id="navmenu" className={`navmenu ${isMenuOpen ? 'active' : ''}`}>
                    <ul>
                        ...
                        <li className={`dropdown ${openDropdown === 'about' ? 'open' : ''}`}>
                            <Link to="/about" onClick={closeMenu}>
                                <span>À propos</span> <i className="bi bi-chevron-down toggle-dropdown" onClick={() => toggleDropdown('about')}></i>
                            </Link>
