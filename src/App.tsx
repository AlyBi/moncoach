...
//         <Route path="/blog-details/:id" element={<BlogDetails />} /> {/* Détail de l'article */}
//         <Route path="*" element={<Home />} /> {/* Redirige toutes les autres routes vers Home */}
//         <Route path="/404" element={<Error404 />} />
//         <Route path="*" element={<Navigate to="/404" />} /> {/* Route par défaut pour les pages non trouvées */}
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/blog-details/:id" element={<BlogDetails />} /> {/* Détail de l'article */}
        <Route path="/404" element={<Error404 />} />
        <Route path="*" element={<Error404 />} /> {/* Route par défaut pour les pages non trouvées */}
      </Routes>
      <Footer />
    </Router>
  );
