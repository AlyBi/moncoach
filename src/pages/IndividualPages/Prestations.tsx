...
const Prestations: React.FC = () => {
    useEffect(() => {
        ...
        AOS.init({
            ...
            easing: 'ease-out', // Easing pour l'animation
        });

        // Code de nettoyage (si nécessaire)
        return () => {
            AOS.refresh(); // Pour rafraîchir les animations si tu mets à jour le contenu
        };
    }, []);
    ...
    return (
        <main className="main">
            ...
            {/* Section Prestations */}
            <section id="prestations" className="Prestations section">
                <div className="container">
                    <div className="row gy-4">
                        {/* Exemple de prestation - Premier élément */}
                        <div className="col-xl-3 col-md-6 mb-4" data-aos="fade-up" data-aos-offset="100" data-aos-duration="1000">
                                ...
                                <div className="flip-card">
                                    <div className="flip-card-inner">
                                        ...
                                        <div className="flip-card-back">
                                            ...
                                            <a href="https://facebook.com" className="fa fa-facebook" aria-label="Facebook"></a>
                        ...
                        {/* Autres prestations */}
                        {/* Tu peux ajouter d'autres prestations avec le même format */}
                        <div className="col-xl-3 col-md-6 mb-4" data-aos="fade-up" data-aos-offset="100" data-aos-duration="1000">
                            <div className="card border-0">
                                <div className="flip-card">
                                    <div className="flip-card-inner">
                                        ...
                                        <div className="flip-card-back">
                                            ...
                                            <a href="https://facebook.com" className="fa fa-facebook" aria-label="Facebook">Facebook</a>
                                            <a href="https://twitter.com" className="fa fa-twitter" aria-label="Twitter">Twitter</a>
                                            <a href="https://linkedin.com" className="fa fa-linkedin" aria-label="LinkedIn">LinkedIn</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
